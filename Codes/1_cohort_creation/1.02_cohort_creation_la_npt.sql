...
-- HOW TO TREAT THOSE WITH DIFFERENT RECORDED RELATIONSHIPS? -- suggest exclude from relationship analysis.
-- HOW TO TREAT THE CARER_ALF_PE THAT MATCHES 2 CARER_ID? -- combined these rows so the individual has 1 row 2 carer assessments.
