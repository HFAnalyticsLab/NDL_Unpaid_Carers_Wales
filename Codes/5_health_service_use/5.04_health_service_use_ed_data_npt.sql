 ...
 * 	- 1.1. Select main variables from deduplicated table (PEJE_MATCHED_COHORT_NPT)
 * 	- 1.2. Left join to ED 
...
DROP TABLE SAILW1429V.PEJE_MATCHEDCOHORT_ED_NPT_2_STEP1;

CREATE TABLE SAILW1429V.PEJE_MATCHEDCOHORT_ED_NPT_2_STEP1
(ALF_PE BIGINT
...
INSERT INTO SAILW1429V.PEJE_MATCHEDCOHORT_ED_NPT_2_STEP1
-- 1. Get ED info for those with an attendance in the year prior to being identified as a carer
	-- 1.1. Select main variables from deduplicated table (PEJE_NPT_GP_LA_STEP4)
SELECT
	DISTINCT J.ALF_PE,
	...
	ED.ADMIN_ARR_DT,
	ED.ADMIN_END_DT 
FROM SAILW1429V.PEJE_MATCHED_COHORT_NPT_2 J
-- 1.2. Left join to ED 
...
DROP TABLE SAILW1429V.PEJE_MATCHEDCOHORT_ED_NPT_2;

CREATE TABLE SAILW1429V.PEJE_MATCHEDCOHORT_ED_NPT_2 
(ALF_PE BIGINT,
SEX INTEGER,
SEX_DESC VARCHAR(10),
AGE INTEGER,
...
INSERT INTO SAILW1429V.PEJE_MATCHEDCOHORT_ED_NPT_2
SELECT DISTINCT 
J.ALF_PE,
J.SEX,
J.SEX_DESC, 
...
B.ADMIN_END_DT
FROM SAILW1429V.PEJE_MATCHED_COHORT_NPT_2 J
LEFT JOIN ( SELECT * FROM SAILW1429V.PEJE_MATCHEDCOHORT_ED_NPT_2_STEP1 ) B 
...
SELECT 
	COUNT(*)
FROM 
	SAILW1429V.PEJE_CARERS_ED_NPT_2; 
-- Carer count
SELECT 
	COUNT(UNIQUE(ALF_PE))
FROM 
